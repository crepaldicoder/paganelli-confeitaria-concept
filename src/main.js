...
<header class="topbar">
  <a class="brand" href="#inicio" aria-label="Paganelli, início"><span class="brand-p">P</span><span><b>Paganelli</b><small>confeitaria</small></span></a>
  <nav class="desktop-nav" aria-label="Principal"><a href="#oficio">O ofício</a><a href="#mesa">Da vitrine</a><a href="#visita">Visite</a></nav>
...
<div class="mobile-menu" id="menu" aria-hidden="true">
 ...
 <nav aria-label="Navegação móvel"><a href="#inicio">01 — Início</a><a href="#oficio">02 — O ofício</a><a href="#mesa">03 — Da vitrine</a><a href="#visita">04 — Visite</a></nav>
...
<section class="visit" id="visita">
 <div class="chapter reveal"><span>Capítulo 03</span><b>Visite</b></div>
...
<footer><div class="footer-brand"><span class="brand-p">P</span><b>Paganelli</b></div><p>Conceito independente de landing page.<br>Não é o site oficial da Confeitaria Paganelli.</p><a href="#inicio">Voltar ao início ↑</a></footer>`;
