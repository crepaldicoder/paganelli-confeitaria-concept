...
<div class="build-intro" aria-hidden="true"><div class="intro-panel intro-panel--left"></div><div class="intro-panel intro-panel--right"></div><div class="intro-stage"><span class="intro-index">SÃO JOSÉ DO RIO PRETO · 1947</span><object class="intro-logo-revised" data="/images/paganelli-escrita-revisada.svg" type="image/svg+xml" tabindex="-1"><img src="/images/logo-paganelli-static.svg" alt=""></object><p>uma receita construída<br>traço por traço</p></div></div><div class="scroll-progress" aria-hidden="true"><i></i></div>
<header class="topbar">
