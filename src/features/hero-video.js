// Video da fachada no hero: aquecimento (Android/iOS), scrub pelo scroll e recuperacao
// quando o navegador descarta o video ou solta o decodificador.
...
let thresholdEl=null,thresholdVideo=null;
// para o painel de diagnostico (?diag=1)
export const heroVideoDebug={get video(){return thresholdVideo},get lastPaint(){return lastVideoPaint}};

// Retorna {el, update} para o loop de scroll, ou null com reduced motion (so o poster).
export const initHeroVideo=reduced=>{
 thresholdEl=document.querySelector('.threshold');thresholdVideo=document.querySelector('.threshold-video');
